...
export function EvolutionFlowContent() {
  return (
    <div className="flex-1 flex flex-col bg-gradient-to-br from-white via-purple-50/30 to-white overflow-auto">
      <div className="border-b border-gray-200 bg-white/60 backdrop-blur-sm px-8 py-6">
        ...
        <p className="text-sm text-gray-500 mt-1">基于自然语言反馈的人机协同进化完整流程</p>
      </div>
          ...
          <div className="grid grid-cols-[1fr_auto_1fr_auto_1fr] gap-6 items-center">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-sm text-gray-900">用户给出自然语言反馈</h2>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-sm text-gray-900">AI解析反馈并优化输出</h2>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-white border border-green-200 rounded-xl p-4">
                ...
                <p className="text-xs text-gray-900 leading-relaxed mb-4">
                  **贵州茅台2025年报摘要**
                  <br />
                  <br />
                  <span className="bg-green-100 px-1 rounded">
                    📊 业绩预期：2026年营收目标1,350亿元（+9.4%），净利润预期680亿元（+10.2%）
                  </span>
                  <br />
                  <br />
                  <span className="bg-green-100 px-1 rounded">
                    ⚠️ 风险点：①高端消费需求不确定性 ②估值处于历史高位
                  </span>
                </p>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-sm text-gray-900">完成自进化，存储用户偏好</h2>
              </div>
